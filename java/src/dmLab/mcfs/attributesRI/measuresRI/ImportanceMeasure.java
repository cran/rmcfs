...
public abstract class ImportanceMeasure
{
    ...
    //********************************    
    public ImportanceMeasure(MCFSParams cfg)
    {
        this.cfg=cfg;
    }
    //********************************
    ...
    //********************************
    public abstract double calcAttrImportance(ExperimentIndicators experimentIndicators, AttributeIndicators indicators);    
    //********************************
    public abstract double calcAttrImportance();
    //********************************
}
