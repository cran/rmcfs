...
public class NodesMeasure extends ImportanceMeasure
{
	//this measure adds 1 every time when attribute is used for split in the node
    public NodesMeasure(MCFSParams cfg)
    {
        super(cfg);
        name = MEASURE_NODES;
    }
