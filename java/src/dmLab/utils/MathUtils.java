...
//  *********************************************
    ...
    {
        return MathUtils.avg(array,0,array.length);
    }
    //***************************************************
    ...
    //***************************************************
	public static float avg(float array[], int start, int stop)
	{
    ...
    //***************************************************
	public static double avg(double array[], int start, int stop)
	{
	    if(stop> array.length || stop<=start)
	        return Float.NaN;
